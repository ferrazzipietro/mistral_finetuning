...
input_data_dir_path = 'data/llama/7B_8bit_FT' # data/qwen/7B_NoQuantbit_base
output_data_path = 'data/evaluation_results/llama_7B_8bit_FT.csv'#qwen_7B_NoQuant_base
