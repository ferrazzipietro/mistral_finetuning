...
input_data_dir_path = 'data/mistral/4bit_FT' # data/qwen/7B_NoQuantbit_base
output_data_path = 'data/evaluation_results/mistral_4bit_FT.csv'#qwen_7B_NoQuant_base
