...
class Evaluator():
    ...
    def _entity_equal_to_ground_thruth_entity(self, entity_in_model_resonse: str, entity_in_ground_truth: str, threshold: int) -> (bool, str):
        """
    ...
    def entity_in_ground_thruth_list(self, entity_in_model_resonse: str, ground_truth: list, threshold: int) -> (bool, str):
        """
        ...
        for entity_in_ground_truth in ground_truth:
            is_in, string = self._entity_equal_to_ground_thruth_entity(entity_in_model_resonse, entity_in_ground_truth, threshold)
            if is_in:
    ...
    def _extract_TP_FP_FN(self, model_response: str, ground_truth: str, similar_is_equal:bool, similar_is_equal_threshold: int) -> [int, int, int]:
        ...
        if similar_is_equal:
            for i, response_entity in enumerate(model_response):
                model_response[i] = self.entity_in_ground_thruth_list(response_entity, ground_truth, similar_is_equal_threshold)
